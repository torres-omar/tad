$(window).on("load", function () {
    ...
    var offer_acceptance_ratios_bubbles = $("#chart-status_offer-ratios .chart-status_bubble");
    var offer_acceptance_ratio_date = $("#offer-acceptance-ratio_date");
